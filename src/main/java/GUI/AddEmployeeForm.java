...
public class AddEmployeeForm extends javax.swing.JFrame {
    ...
    public AddEmployeeForm(Manager_GUI managerGUI) {
        this.managerGUI = managerGUI;
        initComponents();
        setLocationRelativeTo(null);

        cboPermission.addItem("Nhân viên");
        cboPermission.addItem("Quản lý");
        btnOK.setText("Thêm");
    }

    public AddEmployeeForm(Manager_GUI managerGUI, Employee_DTO employeeDTO) {
        ...
        txtPhoneNumber.setText(employeeDTO.getPhoneNumber());
        if (employeeDTO.getPermission().equals("Nhân viên")) {
            cboPermission.addItem("Nhân viên");
            cboPermission.addItem("Quản lý");
        } else {
            cboPermission.addItem("Quản lý");
        ...
        spnSalary.setValue(employeeDTO.getSalary());
        btnOK.setText("Sửa");
    }
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        System.out.println("cbo permission get select item: " + cboPermission.getSelectedItem());
        System.out.println("cbo permissionget select index: " + cboPermission.getSelectedIndex());
        employeeDTO.setPermission(cboPermission.getSelectedItem().equals("Nhân viên") ? "staff" : "manager");
        employeeDTO.setPhoneNumber(txtPhoneNumber.getText());
        employeeDTO.setSalary((int) spnSalary.getValue());
        Date now = new Date();
        Timestamp startDate = new Timestamp(now.getTime());
        employeeDTO.setStartDate(startDate);
        if (btnOK.getText().equals("Thêm")) {
            if (t.addEmployee(employeeDTO)) {
            ...
            if (t.updateEmployee(employeeDTO)) {
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        int qes = JOptionPane.showConfirmDialog(null, "Xác nhận hủy", "Question", JOptionPane.YES_NO_OPTION);
